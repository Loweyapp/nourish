  ...
  return (
    <div>
      ...
      <button onClick={() => setShowGPReport(true)}
        style={{ width: '100%', padding: '12px', background: '#fff', border: '1.5px solid #5a9ea0', borderRadius: 12, fontSize: 14, fontFamily: 'inherit', fontWeight: 600, color: '#5a9ea0', cursor: 'pointer', marginBottom: 12 }}>
        📋 Generate GP report
      </button>
